...
import thesis.utils.SessionSupport.SessionConfig
...
object AppSettings {
  ...
  val masterHost = appConfig.getString("master.host")
  val masterPort = appConfig.getInt("master.port")
  val nodeName = appConfig.getString("name")
